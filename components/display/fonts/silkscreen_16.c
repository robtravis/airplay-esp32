 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font Silkscreen-Regular.ttf --size 16 --bpp 1 --format lvgl --range 0x20-0x7F --lv-include lvgl.h -o silkscreen_16.c
 ******************************************************************************/
...
#ifndef SILKSCREEN_16
#define SILKSCREEN_16 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t silkscreen_16 = {
#else
lv_font_t silkscreen_16 = {
#endif
